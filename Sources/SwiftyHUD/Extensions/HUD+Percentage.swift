...
extension SwiftyHUD {
    ...
    /// Creates a SwiftyHUD representation showing the progress of the task in percent with an animated circle filling.
    /// - Parameters:
    ...
    /// - Returns: New instance of SwiftyHUD with progress that displays ``ProgressPercentageIndicatorView``.
    ...
    ///   Can be `nil` to show without animation.
    ///   - style: The style that will be applied to the appearance of the SwiftyHUD.
    /// - Returns: New instance of SwiftyHUD with progress that displays ``ProgressPercentageIndicatorView`` in the center
