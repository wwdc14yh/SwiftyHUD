...
extension SwiftyHUD {
    ...
    /// Creates a SwiftyHUD representation showing that the task is in progress with an activity indicator.
    /// - Parameters:
    ...
    /// - Returns: New instance of SwiftyHUD with progress that displays ``ProgressActivityIndicatorView``.
    ...
    ///   Can be `nil` to show without animation.
    ///   - style: The style that will be applied to the appearance of the SwiftyHUD.
    /// - Returns: New instance of SwiftyHUD with progress that displays ``ProgressActivityIndicatorView`` in the center
