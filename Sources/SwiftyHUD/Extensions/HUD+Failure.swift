...
extension SwiftyHUD {
    ...
    /// Creates a SwiftyHUD representation showing that the task ended with an error with an animated cross.
    /// - Parameters:
    ...
    /// - Returns: New instance of SwiftyHUD with progress that displays ``ProgressFailureIndicatorView``.
    ...
    ///   Can be `nil` to show without animation.
    ///   - style: The style that will be applied to the appearance of the SwiftyHUD.
    /// - Returns: New instance of SwiftyHUD with progress that displays ``ProgressFailureIndicatorView`` in the center
