...
extension SwiftyHUD {
    ...
    /// Creates a SwiftyHUD representation showing that the task is in progress with the spinner.
    /// - Parameters:
    ...
    /// - Returns: New instance of SwiftyHUD with progress that displays ``ProgressSpinnerIndicatorView``.
    ...
    ///   Can be `nil` to show without animation.
    ///   - style: The style that will be applied to the appearance of the SwiftyHUD.
    /// - Returns: New instance of SwiftyHUD with progress that displays ``ProgressSpinnerIndicatorView`` in the center
