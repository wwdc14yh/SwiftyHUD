...
extension SwiftyHUD {
    ...
    /// Creates a SwiftyHUD representation showing that the task was completed successfully with an animated check mark.
    /// - Parameters:
    ...
    /// - Returns: New instance of SwiftyHUD with progress that displays ``ProgressSuccessIndicatorView``.
    ...
    ///   Can be `nil` to show without animation.
    ///   - style: The style that will be applied to the appearance of the SwiftyHUD.
    /// - Returns: New instance of SwiftyHUD with progress that displays ``ProgressSuccessIndicatorView`` in the center
